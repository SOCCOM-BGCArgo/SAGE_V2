...
d.dirs.esper     = fullfile(user_path,'ESPER\');
d.dirs.caynb     = fullfile(user_path,'CANYON_B\');
d.dirs.WOA       = fullfile(user_path,'WOA2023\');
d.dirs.glodap    = fullfile(user_path,'GLODAPv2\');
...
flds    = flds(tg);
for ct = 1:size(flds,1) % step through saveV2 paths
    fd = d.dirs.(flds{ct});
